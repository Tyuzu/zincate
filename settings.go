...
func getUserSettings(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err == mongo.ErrNoDocuments {
		...
		_, _ = settingsCollection.InsertOne(context.TODO(), userSettings)
	} else if err != nil {
...
func updateUserSetting(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	_, err := settingsCollection.UpdateOne(context.TODO(), filter, updateDoc, opts)
	if err != nil {
...
func initUserSettings(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	err := settingsCollection.FindOne(context.TODO(), bson.M{"userID": userID}).Decode(&existingSettings)
	if err == mongo.ErrNoDocuments {
		// No settings found, create default settings
		newSettings := getDefaultSettings(userID)
		_, err := settingsCollection.InsertOne(context.TODO(), newSettings)
		if err != nil {
